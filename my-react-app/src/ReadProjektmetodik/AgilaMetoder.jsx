...
import AgileApproach from '../../../assets/agile-approach.png';
import kanban from '../../../assets/kanban.png';



function AgilaMetoder() {

  const input = `## **PJ 1.1 Agila metoder (Scrum, Kanban, Extreme Programming)**
  <br>

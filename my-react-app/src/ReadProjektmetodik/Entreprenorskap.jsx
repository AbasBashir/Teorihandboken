...
import WebsiteFactors from '../../../assets/website-factors.png'

function Entreprenorskap() {
    const input = `## **PJ 1.3 Entreprenörskap inom webbutveckling**
 <br>
 ...
 <br>
    <p align ="center ">
        <img src="${WebsiteFactors}" width="550" height="400">
    </p>   
 <br>
...
export default Entreprenorskap
